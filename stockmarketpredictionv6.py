...
print("Strike price of In Money Call Option /Out of money Put Option: "+str(max(belowStockPrice)))
for t in range(T+1):
  #Maximum Risk
  InMoneyOptionPriceHighRisk=(max(aboveStockPrice)-max(belowStockPrice))+math.pow(math.e,-t/T)
  print("In Money Call Option /Out of money Put Option, Price on Day: "+str(t+1)+" is "+str(InMoneyOptionPriceHighRisk))
...
if len(aboveStockPrice) == 0:
  aboveStockPrice=[]
  aboveStockPrice.append(stockPrice)
print("Strike price of Out of Money Call Option/In the Money Put option "+str(min(aboveStockPrice)))
for t in range(T+1):
  #Maximum Risk
  InMoneyOptionPriceHighRisk=(max(aboveStockPrice)-min(aboveStockPrice))+math.pow(math.e,-t/T)
  print("Out of Money Call Option/In the Money Put option, Price on Day: "+str(t+1)+" is "+str(InMoneyOptionPriceHighRisk))
